...
class FtpScriptWriter {
    ...
    private let folderNames = ["2019", "2020", "2021", "2022", "archive", "images", "impressum", "index", "statistic", "tags", "serials", "xml", "search", "random", "beta", "timeline", "persons", "movies", "books", "wordcloud", "experiments"]
